class PendulumPositionBased{
  ...
  PendulumPositionBased child = null;
  PendulumPositionBased parent = null;
  
  PendulumPositionBased(float _x, float _y, float _len, float _angle, int chain, PendulumPositionBased _parent){
    ...
    if(chain > 0){
      child = new PendulumPositionBased(pos.x, pos.y, _len, _angle + 0.4, chain - 1, this);
    }
  }
